      ...
      <div className="min-h-screen flex flex-col justify-center">
        <main>
          ...
          <p className="text-center">
            Remix and Supabase for server rendered web applications, pretty good
            setup for eslint, prettier, git hooks, etc. and friction-less and
            robust UI development with TailwindCSS, DaisyUI and Headless UI
          </p>
        </main>
        <aside className="text-center mt-4">
          ...
          <ul className="flex flex-row justify-center gap-2">
            {data.resources.map((resource) => (
              <li
                key={resource.url}
                className="remix__page__resource text-gray-600"
              >
